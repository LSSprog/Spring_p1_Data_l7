...
public class ProductController {
    private final ProductRepository productRepository; // это пока не правльно! потом будет правильно. Это пока облегчит код (сервис вроде надо ещё)
    ...
    public String deleteProductById (@PathVariable Long id) {
        ...
        return "redirect:/prod"; // почему не срабатывает?
    }
